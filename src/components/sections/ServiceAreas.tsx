...
const ServiceMap = lazy(() => import('../ui/ServiceMap'))
...
const futureMarkets = [
  ...
  { 
    ...
    waitlistCount: 189,
    description: "Expanding medical nail care to Detroit",
    population: "670K"
  },
  { 
    name: "Cleveland",
    ...
    status: "Future Market",
    waitlistCount: 156,
    description: "Professional nail care for Cleveland communities",
    population: "380K"
  },
  { 
    name: "Indianapolis",
    ...
    status: "Future Market",
    waitlistCount: 178,
    description: "Medical nail care coming to Indianapolis",
    population: "870K"
  }
]
          ...
          <Card className="relative overflow-hidden border-2 border-[#0A5C99]">
            ...
            <CardContent>
              <div className="space-y-4">
                ...
                <Button 
                  className="w-full bg-[#0A5C99] hover:bg-[#1E88E5] mt-4"
